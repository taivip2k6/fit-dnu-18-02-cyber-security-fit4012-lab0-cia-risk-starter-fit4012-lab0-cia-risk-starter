...
2. Mapping CIA
Ghép các sự cố phổ biến với từng mục tiêu bảo mật:
...
3. Phân tích sự cố B (Vi phạm tính Toàn vẹn)
...
5. Bonus Flag
Dựa trên thứ tự sắp xếp phổ biến trong giáo trình (C-I-A), Flag của bạn sẽ là:
